<?php 
    ...
    function DisplayNav($db, $url) {
        ...
        if(!IsLoggedIn()) {
            ...
            if( $url == STATS_LINK || $url == ITEM_STATS_LINK ) {
                echo "<li><a style='text-decoration:none;' onclick='closeNav();' href='" . STATS_LINK . "'><span style='font-size:0.7em; background-color: #9d9159;' class='nav_buttons nav_buttons_stats'>By Date</span></a><li>";
                echo "<li><a style='text-decoration:none;' onclick='closeNav();' href='" . ITEM_STATS_LINK . "'><span style='font-size:0.7em; background-color: #9d9159;' class='nav_buttons nav_buttons_stats'>By Item</span></a><li>";
            }
