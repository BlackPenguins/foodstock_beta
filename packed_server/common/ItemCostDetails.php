...
class ItemCostDetails extends TestingBase {
	...
	public function testSetup( $user )
    {
        ...
        GetMessage( "InfoMessage" );
        GetMessage( "UserErrorMessage" );

        addItem($this->db, $this->itemName, $this->itemPrice / 100.00, $this->itemDiscountPrice / 100.00, $this->itemType);
        $createItemResponse = GetMessage( "InfoMessage" );
        $this->assertText("$this->itemName Item Success", $createItemResponse, "Item <b>$this->itemName</b> added");

        addItem($this->db, $this->itemName, $this->itemPrice / 100.00, $this->itemDiscountPrice / 100.00, $this->itemType);
        $createItemResponse = GetMessage( "UserErrorMessage" );
        $this->assertText("$this->itemType Item Already Exists", $createItemResponse, "Item <b>$this->itemName</b> already exists");
